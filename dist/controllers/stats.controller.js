...
export var getStats = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var repository, coupons, assignedCoupons, notAssignedCoupons, couponsAssignedByDay, couponsExpiresByDay, Stats, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                coupons = _a.sent();
                assignedCoupons = coupons.filter(function (coupon) {
                    return coupon.assigned_at !== null;
                });
                notAssignedCoupons = coupons.length - assignedCoupons.length;
